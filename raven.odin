...
Context :: struct {
	...
	gfx_ctx 		: Graphics_Context(FRAMES_IN_FLIGHT),
}

Core_Context : Context

initialize_bare :: proc() -> (ok : bool = true) {
...
initialize_window :: proc(window_cfg : Window_Config) -> (ok : bool = true) {
	initialize_bare() or_return

	Core_Context.gfx_ctx = create_graphics_context(
...
shutdown :: proc() {
	...
	destroy_graphics_context(Core_Context.device, Core_Context.gfx_ctx)
