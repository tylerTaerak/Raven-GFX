...
// create_asset_handler :: proc() -> (handler : Asset_Store, ok : bool = true) {
...
// }
// 
// _cycle_semaphores :: proc(handler : ^Asset_Store) {
...
// }
// 
// load_model :: proc(handler : ^Asset_Store, filepath : string) -> (handle : Model_Handle) {
...
// }
// 
// load_shader :: proc(handler : ^Asset_Store, config : ^gvk.Shader_Chain_Config) -> (handle : Shader_Handle, ok : bool = true) {
...
// }
// 
// destroy_asset_handler :: proc(handler : ^Asset_Store) {
